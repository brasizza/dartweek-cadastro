 ...
 style="padding:0px;">
    ...
    <div style="  text-align: center;  ">
        ...
        <div style="padding-top:20px;  font-size:18px!important">
            ...
            <span>Este é um presente nosso para você, por ter se dedicado tanto essa semana!</span><br>
            <span>Nosso segundo presente, é a <strong>liberação de uma aula extra</strong>, exclusiva dos
                <strong>alunos</strong> da Academia do Flutter.<br>
                Como você percorreu este caminho árduo, iremos disponibilizar para que você possa assistir também:
                </strong></span><br>
            <br>
            ...
            <span
                ...
                <strong>
                    <h3 class="button"><a href="https://www.youtube.com/watch?v=SjeCU2jniIg&feature=youtu.be"
                            style="color: white" target="_blank">Link para acessar</a></h3>
                </strong>
            </span> <br><br>
            ...
            <span>Rodrigo Rahman e Equipe</span><br>
        </div>
</body>
